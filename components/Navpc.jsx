  ...
  return (
    <div className='navpc'>
        ...
        <div className='navpc-pgs'>
            ...
            <Link to={'/news'} onMouseEnter={()=>setMenu4(true)} onMouseLeave={()=>setMenu4(false)} style={{backgroundColor:page==="news" ? "#3e7742" : "",color:page==="news" ? "#f0f0f0":"", transform:page!=="news" && menu4===true ? 'scale(1.15)':'scale(1)'}} className='navpc-pgs1'>Events</Link>
