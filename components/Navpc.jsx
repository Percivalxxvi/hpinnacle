...
const Navpc = ({page}) => {
  ...
  return (
    <div className="hidden lg:flex h-35 items-center justify-center gap-50 px-10 md:px-20 lg:px-32 py-4 sticky top-0 z-50 bg-[#EDEDEDCC] shadow-md border-b-3 border-[gold]">
