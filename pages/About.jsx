...
const About = () => {
  return (
    <div className="flex flex-col gap-3 lg:flex lg:flex-col lg:gap[30px]">
      <Navmob />
      <div className="flex lg:hidden h-20"></div>
      <Navpc page="about" />
      <div className="flex flex-col items-center justify-center lg:h-fit border-0 border-[gold] gap-3">
        <div className="h-fit w-full flex flex-col items-center justify-center lg:h-100 lg:flex-row lg:mt-20 mt-10 border-2 border-[gold]">
          ...
          <div className="lg:ml-10 lg:h-100 lg:w-2/4 w-[95%] h-fit flex flex-col items-center justify-evenly p-5">
            <h1 className="text-4xl lg:text-6xl lg:text-left lg:w-[95%]">
              About the School
            </h1>
        ...
        <div className="h-fit w-full flex flex-col items-center justify-center lg:h-100 lg:flex-row-reverse lg:mt-20 mt-10 border-2 border-[gold] lg:justify-between">
          ...
          <div className="lg:ml-10 lg:h-100 lg:w-3/4 flex flex-col justify-evenly p-5 h-100 w-full items-center">
            <h1 className="text-4xl lg:text-6xl lg:text-left lg:w-[95%] w-[95%] text-center">
        ...
        <div className="h-fit w-full flex flex-col items-center justify-center lg:h-100 lg:flex-row lg:mt-20 mt-10 lg:border-b-2 border-2 border-[gold] lg:justify-between">
          <div className="lg:h-100 lg:w-150 h-70 w-full bg-amber-400">
            <img
              className="lg:h-4/4 lg:object-cover lg:w-150 h-70 w-full object-cover border-b-2 border-t-2 border-[gold]"
