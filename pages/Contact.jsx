...
const Contact = () => {
  return (
    <div className="flex flex-col gap-2 bg-[#3e7742]">
      ...
      <div className="flex flex-col items-center justify-center bg-[#3e7742] lg:h-150 h-320 pt-5 border-2 border-white">
        <div className="flex flex-col items-center justify-center text-white gap-10 lg:w-[80%] text-center">
      ...
      <div className="flex flex-col lg:h-[40vh] h-50 lg:flex-col bg-[#3e7742] items-center justify-center gap-10 border-2 border-white p-9">
        <h3 className="text-4xl mt-5 text-white">Connect with us</h3>
